...
CROSS JOIN filtered_employees e2
CROSS JOIN filtered_employees e3
CROSS JOIN filtered_departments d1
CROSS JOIN filtered_departments d2
CROSS JOIN filtered_departments d3
WHERE e1.id != e2.id 
    AND e2.id != e3.id 
    AND e1.id != e3.id
